    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
      <jet-form-section @submitted="submit">
        ...
        <template #description>
          En este formulario se registra la información de la administración,
          generalmente un edificio o conjunto residencial junto con la
...
export default {
  ...
  props: ["departments", "allDistricts"],
  setup(props) {
    const form = useForm({
      name: null,
